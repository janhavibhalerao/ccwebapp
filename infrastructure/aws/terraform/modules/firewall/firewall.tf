resource "aws_cloudformation_stack" "firewall" {
  ...
  parameters = "${map("loadBalancerArn", "${var.loadBalancer}")}"
        ...
        "AdminAccessRule":{
          ...
          "Properties":{
            ...
            "Predicates":[
              ...
              "Type":"ByteMatch",
              "Negated":false,
              "DataId":{"Ref":"AdminUrlStringSet"}
            },
            {
            "Type":"IPMatch",
            "Negated":true,
            "DataId":{"Ref":"AdminRemoteAddrIpSet"}
          }]
          }
        },
        ...
        "PHPInsecureRule":{
          ...
          "Properties":{
              ...
              "Predicates":[
                  ...
                  "Type":"ByteMatch",
                  "Negated" : false,
                  "DataId":{"Ref":"PHPInsecureQSStringSet"}
              },
              {
                  "Type":"ByteMatch",
                  "Negated" : false,
                  "DataId":{"Ref":"PHPInsecureURIStringSet"}
              }
              ]
          }
        },
        ...
        "ServerSideIncludeRule":{
          ...
          "Properties":{
              ...
              "Predicates":[
                  ...
                  "Type":"ByteMatch",
                  "Negated" : false,
                  "DataId":{"Ref":"ServerSideIncludeStringSet"}
              }]
          }
        },
        "BlacklistIpSet":{
            ...
            "Properties":{
                ...
                "Rules":[
                    ...
                    },
                    {
                        ...
                        "Priority":80,
                        "RuleId":{"Ref":"ServerSideIncludeRule"}
                    },
                    {
                        "Action":{
                            "Type":"BLOCK"
